...
const CartContainer = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 w-full md:w-375 h-screen bg-white md:backdrop-blur-md bg-opacity-50 shadow-md flex flex-col z-[101]"
    >
      <div className="w-full flex items-center justify-between p-4 cursor-pointer">
        <motion.div onClick={showCart} whileTap={{ scale: 0.75 }}>
          <MdArrowRightAlt className="text-textColor text-3xl" />
        </motion.div>
